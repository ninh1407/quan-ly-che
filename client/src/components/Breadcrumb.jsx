...
const labels = {
  dashboard: 'Tổng quan', balanceSheet: 'Bảng cân đối', finishedStock: 'Thành phẩm', sales: 'Thu', purchases: 'Nhập', expenses: 'Chi phí', suppliers: 'Nhà CC', customers: 'Người mua', debts: 'Công nợ', staff: 'Phiếu', admin: 'Quản trị', season: 'Theo Đợt'
}
